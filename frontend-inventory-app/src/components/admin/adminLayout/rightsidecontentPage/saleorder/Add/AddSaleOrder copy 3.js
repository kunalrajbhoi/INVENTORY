...
function AddSaleOrder() {
  ...
  async function handleSubmitForm(e) {
    ...
    // const productsData = productData.map(({ productName, ...rest }) => rest);

    // console.log("sssssssssssssssssssss",productsData);
              ...
              <Form>
                ...
                <Form.Group>
                  ...
                  >
                    ...
                    {productdetail &&
                      productdetail.stock?.map((stockItem, index) => (
                        <option key={index}>{stockItem.quantity}</option>
                      ))}
                  </Form.Select>
                </Form.Group>
                ...
                <Form.Group>
                  ...
                  >
                    ...
                    {productdetail &&
                      productdetail.stock?.map((stockItem, index) => (
                        <option key={index}>{stockItem.color}</option>
                      ))}
                  </Form.Select>
                </Form.Group>
                ...
                <Form.Group>
                  ...
                  >
                    ...
                    {productdetail &&
                      productdetail.stock?.map((stockItem, index) => (
                        <option key={index}>{stockItem.gender}</option>
                      ))}
                  </Form.Select>
                </Form.Group>
                ...
                <Form.Group>
                  ...
                  >
                    ...
                    {productdetail &&
                      productdetail.stock?.map((stockItem, index) => (
                        <option key={index}>{stockItem.size}</option>
                      ))}
                  </Form.Select>
                </Form.Group>
